@extends('user.layouts.default', ['title' => 'Courriers reçus'])
@section('content')
    <!-- Bread crumb and right sidebar toggle - CONTENT HEADER -->
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Courriers reçus</h4>
                ...
                <div class="d-flex no-block justify-content-end align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Courriers reçus</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-8 offset-md-2">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('recevedSearch') }}">
                            @csrf
            ...
            <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      <h2 class="card-title text-center">Liste des courriers reçus</h2>
                      ...
                      <div class="table-responsive">
                          <table id="zero_config" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                  @foreach ($receveds as $receved)
                                  <tr>
                                      <td>{{ $loop->iteration }}</td>
                                      <td>{{ $receved->created_at->format('d/m/Y') }}</td>
                                      <td>{{ $receved->destinataire }}</td>
                                      <td>{{ $receved->expeditaire }}</td>
                                      <td>
                                          <a href="{{route('receved.show', $receved)}}" class="btn btn-primary"><i class="fa fa-eye"></i> </a>
                                          <a href="{{route('receved.edit', $receved)}}" class="btn btn-success"><i class="fa fa-edit"></i> </a>
                                          
                                          {{-- <a href="#" class="btn btn-danger"><i class="fa fa-trash"></i></a> --}}

                                          <!-- Button trigger modal -->
                                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#Modal{{ $receved->id }}">
                                              <i class="fa fa-trash"></i>
                                          </button>

                                          <!-- Modal -->
                                          <div class="modal fade" id="Modal{{ $receved->id }}" tabindex="-1" role="dialog" aria-labelledby="ModalLabel{{ $receved->id }}" aria-hidden="true">
                                              <div class="modal-dialog">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                  <h5 class="modal-title" id="ModalLabel{{ $receved->id }}"><span class="text-danger">Suppréssion d'élément</span></h5>
                                                  ...
                                                  <form action="{{ route('receved.destroy', $receved) }}" method="post">
                                                      @csrf
                                                      @method('DELETE')
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    <div class="card-body">
                        <a href="{{route('receved.create')}} " class="btn btn-default btn-lg btn-block">Nouvel reception</a>
                    </div>
                </div>
            </div>
        </div>
